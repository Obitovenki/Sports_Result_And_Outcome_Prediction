...
def choosesite():
    return render_template("choosesite.html")

@app.route('/Football_Analysis')
def FootballAnalysis():
    return render_template("EPL 2020-21 Exploratory Data Analysis.html")

@app.route('/Analysis')
def CricketAnalysis():
    return render_template('t20_data_preprocessing.html')
